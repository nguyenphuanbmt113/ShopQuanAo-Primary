          ...
          <table className="table-auto w-full">
            <thead className="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
              <tr>
                ...
                <th className="p-2 whitespace-nowrap text-black text-md">
                  <div className="font-semibold text-left">Số lượng mua</div>
                </th>
                <th className="p-2 whitespace-nowrap text-black text-md">
              ...
              {data &&
                data?.orders.map((item, index) => {
                  const total = currency.format(
                    discount(item.productId.price, item.productId.discount) *
                      item.quantities,
                    {
                      code: "USD",
                    }
                  ...
                  return (
                    <>
                      <tr key={index}>
                        ...
                        <td className="p-2 whitespace-nowrap text-black text-md">
                          <div className="px-2 py-1 bg-yellow-500 text-white rounded-md font-medium text-center">
                            Chi tiết
                          </div>
                        </td>
                      </tr>
